...
- Groq generates the final answer using only the retrieved approved context.
...
- The app enforces strict context-based response generation with Groq to minimize hallucination.
